...
MASTER_STOCKS = [
    ...
    {"ticker": "FLUT", "name": "Flutter Entertainment plc", "region": "US", "currency": "USD"},
    {"ticker": "AMZN", "name": "Amazon.com, Inc.", "region": "US", "currency": "USD"},
    {"ticker": "NVDA", "name": "NVIDIA Corporation", "region": "US", "currency": "USD"},
    {"ticker": "ARMK", "name": "Aramark", "region": "US", "currency": "USD"},
    {"ticker": "TSLA", "name": "Tesla, Inc.", "region": "US", "currency": "USD"},
    {"ticker": "BMY", "name": "Bristol-Myers Squibb Company", "region": "US", "currency": "USD"},
    {"ticker": "CBRE", "name": "CBRE Group, Inc.", "region": "US", "currency": "USD"},
    ...
    {"ticker": "ORSTED.CO", "name": "Ørsted A/S", "region": "Europe", "currency": "DKK"},
    {"ticker": "IBE.MC", "name": "Iberdrola, S.A.", "region": "Europe", "currency": "EUR"},
    {"ticker": "SAN.PA", "name": "Sanofi", "region": "Europe", "currency": "EUR"},
    {"ticker": "ROG.SW", "name": "Roche Holding AG", "region": "Europe", "currency": "CHF"},
    ...
    {"ticker": "SVS.L", "name": "Savills plc", "region": "UK", "currency": "GBp"},
    {"ticker": "DOLE.N", "name": "Dole plc", "region": "UK", "currency": "USD"},
    ...
    {"ticker": "PTSB.IR", "name": "PTSB", "region": "Ireland", "currency": "EUR"},
    ...
    {"ticker": "IRES.IR", "name": "Ires Reit Plc", "region": "Ireland", "currency": "EUR"},
    ...
    {"ticker": "A5G.IR", "name": "AIB", "region": "Ireland", "currency": "EUR"},
    {"ticker": "BIRG.IR", "name": "Bank of Ireland", "region": "Ireland", "currency": "EUR"},
    ...
    if c.fetchone()[0] == 0:
        for s in MASTER_STOCKS:
            c.execute("INSERT OR IGNORE INTO stocks VALUES (?, ?, ?, ?)",
                      (s["ticker"], s["name"], s["region"], s["currency"]))
    conn.commit()
    conn.close()
...
if st.button("Run"):
    ...
    for stock in SELECTED_STOCKS:
        ...
        try:
            ...
            # 5-day % change (trading days only)
            prev_window = data.loc[:sel_date].tail(6)
            if len(prev_window) >= 2:
                past_price = float(prev_window.iloc[0]["Close"])
